...
![Without NCP: Cognitive Overload](https://cdn.jsdelivr.net/npm/@portel/ncp@1.0.2/docs/images/without-ncp.png)
...
![With NCP: Intelligent Orchestration](https://cdn.jsdelivr.net/npm/@portel/ncp@1.0.2/docs/images/with-ncp.png)
...
![NCP Architecture Overview](https://cdn.jsdelivr.net/npm/@portel/ncp@1.0.2/docs/images/sequence-diagram.png)

### Dual Architecture: Server + Client
NCP operates as both an MCP server (to your AI client) and an MCP client (to downstream MCPs):

![NCP Dual Architecture](https://cdn.jsdelivr.net/npm/@portel/ncp@1.0.2/docs/images/dual-architecture.png)
...
![Token Optimization Process](https://cdn.jsdelivr.net/npm/@portel/ncp@1.0.2/docs/images/token-optimization.png)
